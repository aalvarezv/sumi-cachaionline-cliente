...
const TableContenido = ({contenidos, pagina_actual, resultados_por_pagina, handleClickModificarContenido, handleClickEliminarContenido}) => {  
                ...
                <tbody>
                    {contenidos.length > 0 &&
                        contenidos.map((contenido, index) =>{
                            ...
                            const {codigo, descripcion, inactivo} = contenido
                                        ...
                                        <Row>
                                            <Col>
                                                <Button
                                                    ...
                                                    onClick={e => {
                                                        setShowConfirmEliminar(!show_confirm_eliminar)
                                                        handleClickEliminarContenido(codigo_eliminar)
                                                    }}
                                                    block
                                                >
                                                    Si
