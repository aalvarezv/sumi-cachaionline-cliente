...
const TableModulo = ({modulos, pagina_actual, resultados_por_pagina, handleClickModificarModulo, handleClickEliminarModulo}) => {  
                ...
                <tbody>
                    {modulos.length > 0 &&
                        modulos.map((modulo, index) =>{
                            ...
                            const {codigo, descripcion, inactivo} = modulo
                            ...
                            return(
                                ...
                                >
                                    ...
                                    <Popover.Title as="h3"><small>¿Desea eliminar el modulo?</small></Popover.Title>
                                    <Popover.Content>
                                        <Row>
                                            <Col>
                                                <Button
                                                    ...
                                                    onClick={e => {
                                                        setShowConfirmEliminar(!show_confirm_eliminar)
                                                        handleClickEliminarModulo(codigo_eliminar)
                                                    }}
                                                    block
                                                >
                                                    Si
